...
int main()
{
	...
	outcoming_ping.frame_id.data = (char*) malloc(STRING_BUFFER_LEN);
	outcoming_ping.frame_id.capacity = STRING_BUFFER_LEN;

	incoming_ping.frame_id.data = (char*) malloc(STRING_BUFFER_LEN);
	incoming_ping.frame_id.capacity = STRING_BUFFER_LEN;

	incoming_pong.frame_id.data = (char*) malloc(STRING_BUFFER_LEN);
